...
%     end
%     save('Phi_gaussian.mat','Phi')
%     load('Phi.mat','Phi')
%     load('opt_Phi.mat','Phi');
%     load('opt_Phi_1.mat')
    load('Phi_gaussian.mat','Phi')
%     Phi = Phi_opt;
...
%                     tau_a
            ...
            Pe_snr(snr_idx) = Pe_total/T;
%            save('ZZB_zero_mean_exp_CF10_N9_gaussian.mat','Pe_snr','SNR')
    end
